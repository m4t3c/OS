...
int main(int argc, char **argv)
{
	...
	{
		printf("Errore nel numero dei parametri: ho bisogno di 1 parametro (stringa da cercare e nome del file in cui cercare) ma argc = %d\n", argc);
		exit(1);
	}
	...
	{
		/* Processo figlio */
		close(0);		/* Chiudo lo standard input per poter ridirezionare su argv[2] */
